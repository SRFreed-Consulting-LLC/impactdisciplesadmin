...
//
// Formats are deliberately limited to email-safe, tag-based ones (bold,
// italic, underline, strike, link, lists) - alignment is a block style and
// text color inherits the email's global styles, so no Quill class-based
// attributors are needed (registering style attributors would be a GLOBAL
// Quill config change affecting the app's 12 other quill-editor sites).
@Component({
